      ...
      <div className="prose prose-lg max-w-4xl mx-auto">
        ...
        <ul className="space-y-3 mb-8">
          <li className="flex items-start">
            ...
            <span>
              ...
              {' '}
              - Real-time updates to regulations and procedures
            </span>
          </li>
          <li className="flex items-start">
            ...
            <span>
              ...
              {' '}
              - 10,000+ aviation topics at your fingertips
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 mr-2">🔍</span>
            <span>
              ...
              {' '}
              - Find any topic in milliseconds
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 mr-2">📱</span>
        ...
        <div className="bg-gray-100 p-6 rounded-lg mt-8">
          ...
          <p>
            Email:
            {' '}
            <a href="mailto:support@cfipros.com" className="text-blue-600 hover:underline">support@cfipros.com</a>
          </p>
        </div>
      </div>
    </>
